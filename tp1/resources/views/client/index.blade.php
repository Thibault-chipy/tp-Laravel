        ...
        <tbody>
            @foreach ($clients as $client)
                <tr>
                    ...
                    <td>
                        <!-- Edit button -->
                        <a href="{{ route('client.edit', $client->numeroClient) }}" class="btn btn-warning btn-sm">Éditer</a>
                        
                        <!-- Show button -->
                        <a href="{{ route('client.show', $client->numeroClient) }}" class="btn btn-info btn-sm">Voir</a>

                        <!-- Delete button -->
                        <form action="{{ route('client.destroy', $client->numeroClient) }}" method="POST" style="display:inline-block;">
                            @csrf
                            @method('DELETE')
